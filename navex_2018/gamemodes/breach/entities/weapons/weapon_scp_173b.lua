--[[
gamemodes/breach/entities/weapons/weapon_scp_173b.lua
--]]
...
SWEP.Purpose		= "Я великий кукурузо"
...
SWEP.SnapSound				= Sound( "weapons/scp173b/scp_173b_fire.mp3" )
SWEP.teams					= {1}
...
function SWEP:SecondaryAttack()
	...
	if CLIENT then
		surface.PlaySound("weapons/scp173b/scp173b_boing.mp3")
	end
	...
	if #foundplayers > 0 then
		...
		for k,v in pairs(foundplayers) do
			...
			v:SendLua( 'surface.PlaySound("weapons/scp173b/scp173b_boing.mp3")' )
