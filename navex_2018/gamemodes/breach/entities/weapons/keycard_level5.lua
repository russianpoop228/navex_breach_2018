--[[
gamemodes/breach/entities/weapons/keycard_level5.lua
--]]
...
SWEP.Instructions	= "Дает вам возможность открывать двери 5 уровня"

SWEP.ViewModelFOV	= 62
SWEP.ViewModelFlip	= false
SWEP.ViewModel		= "models/breach/keycard.mdl"
SWEP.WorldModel		= "models/breach/keycard.mdl"
SWEP.PrintName		= "Карта доступа 5 уровень"
SWEP.Slot			= 1
SWEP.SlotPos		= 1
SWEP.DrawAmmo		= false
...
function SWEP:DrawHUD()
	...
	surface.SetMaterial(Material("navex098/keycard/key5.png"));
