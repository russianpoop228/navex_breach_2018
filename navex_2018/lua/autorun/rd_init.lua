...
local MaxDRagsVar = CreateConVar("ragdeath_keepmax","8",FCVAR_ARCHIVE,"")
...
local TimeRagVar = CreateConVar("ragdeath_timeremove","15", FCVAR_ARCHIVE,"")
