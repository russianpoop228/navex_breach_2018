--[[
lua/weapons/weapon_katana/shared.lua
--]]
if( SERVER ) then
...
SWEP.Author			= "Ba1t"
SWEP.Instructions	= "Press the LMB to slash"
SWEP.Contact		= ""
SWEP.Purpose		= "KILL EVERYONE!"
SWEP.Category		= "SCP-076-2 Swep"
